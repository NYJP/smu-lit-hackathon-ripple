...
export function RegulationsPageContent() {
  ...
  return <div className="mx-auto w-full max-w-6xl px-5 py-8">
    ...
    <div className="mt-5 overflow-x-auto rounded-lg border"><Table><TableHeader><TableRow><TableHead>Title</TableHead><TableHead>Kind</TableHead><TableHead>Status</TableHead><TableHead>Guidelines</TableHead><TableHead>Uploaded</TableHead></TableRow></TableHeader><TableBody>
